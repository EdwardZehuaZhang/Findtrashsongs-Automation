...
def main():
    ...
    if not upload_with_retry(snapchat_upload, video_path, description_file_path, Config.snapchat_cookies_file):
        failed_uploads.append(("Snapchat", snapchat_upload, video_path, description_file_path, Config.snapchat_cookies_file))
